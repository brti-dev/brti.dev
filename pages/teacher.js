    ...
    return (
        <Layout title="Teacher">
            <div className={classes.root}>
                <p>I am a certified teacher of Advanced Placement Histories, Human Geography, and Capstone. As teacher and counselor, I have prepared hundreds of students for academic life abroad, culminating in being appointed leader to launch the AP Capstone research program in our school, one of the first such programs introduced in China. I'm an expert on active learning techniques and inquiry-based learning through primary source documents.</p>
                <Button
                    to="https://www.dropbox.com/s/7coh5m3254xz01p/MathewBerti_resume_teacher.pdf"
                    variant="outlined"
                >
                    <DownloadIcon />
                    Download Résumé
