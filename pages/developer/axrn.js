...
function Axrn() {
    return (
        <Layout>
            <Head>
                <title>AXRN Animal Crossing Right Now - Project by Matt Berti</title>
            </Head>
            <Article
            ...
            >
                ...
                <p>I had also been wanting to learn Python for some time now, especially after <a href="https://insights.stackoverflow.com/survey/2019">Stack Overflow&apos;s 2019 Developer Survey</a> showed Python as the <a href="https://insights.stackoverflow.com/survey/2019#most-popular-technologies">fastest growing tech</a> and among the <a href="https://insights.stackoverflow.com/survey/2019#most-loved-dreaded-and-wanted">most loved and wanted</a>. I took the lockdown as an opportunity to dive in. I learned the basics from the excellent <a href="https://docs.python.org/3/tutorial/index.html">Python Tutorial</a>, then set out researching a web framework. I worked with <a href="https://palletsprojects.com/p/flask/">Django</a> at first and loved all the additional features and packages that came with the software. However, I eventually went with <a href="https://palletsprojects.com/p/flask/">Flask</a> because its small footprint was perfect for a simple app like mine.</p>
            </Article>
        </Layout>
    )
}
