...
function Teacher() {
  return (
    ...
    >
      <div>
        <p>
          I am a certified teacher of Advanced Placement Computer Science,
          Histories, Human Geography, and Capstone (an intensive university
          research prep course). As teacher and counselor, I have prepared
          hundreds of students for academic life abroad, culminating in being
          appointed leader to launch the AP Capstone research program in our
          school, one of the first such programs introduced in China. I'm an
          expert on computer program modeling, active learning techniques, and
        ...
        <Timeline>
          ...
          <TimelineItem label="2011&mdash;2016">
            ...
            <p>
              <strong>
                ESL teacher, lecturer on British and American history and
                culture.
              </strong>
            </p>
            <p>
